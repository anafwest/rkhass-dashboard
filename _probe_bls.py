...
PORT = 9222
req = urllib.request.Request("http://127.0.0.1:%d/json/new?%s" % (PORT, urllib.parse.quote("https://app.alriyadh.gov.sa/BLS/faces/home", safe="")), method="PUT")
...
for i in range(12):
    ...
    print(i, url[:100], adf, myinput, flush=True)
